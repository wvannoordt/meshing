function [points_out, nx] = get_nearest_stretching_ratio_with_blocks(xmin, xmax, dx, ratio, block_size, nbuffer)
	...
	[points_out, ratio_approx] = get_spaced_values_buf(xmin, xmax, dx, nx, nbuffer);
end
